...
# ==========================================
# UJI WILCOXON SIGNED RANKS TEST (SPSS STYLE)
# ==========================================
...
# ==========================================
# UJI NORMALITAS (SHAPIRO-WILK & LILLIEFORS)
# ==========================================
...
def render_normality_table (results :list )->None :
    ...
    for r in results :
        ...
        p_sw_color ="#ef4444"if sw_sig else "inherit"
...
# ==========================================
# UJI PAIRED SAMPLES T-TEST (PARAMETRIK)
# ==========================================
...
def render_spss_wilcoxon (pairs_data ):
    ...
    bg_subheader ="#334155"if is_dark else "#ececec"
    bg_first_col ="#1e293b"if is_dark else "#f5f5f5"
    bg_sig_col ="rgba(96, 165, 250, 0.15)"if is_dark else "#eaf4ff"
    text_color ="#f1f5f9"if is_dark else "#0f172a"
    text_soft ="#94a3b8"if is_dark else "#64748b"
    border_color ="#475569"if is_dark else "#aaa"
    border_cell ="#334155"if is_dark else "#bbb"
...
# ==========================================
# HALAMAN OVERVIEW (RINGKASAN & STATISTIK INTEGRASI)
# ==========================================
if menu =="Overview":
    ...
    if df_pos_ov [columns_pref [1 :]if 'columns_pref'in dir ()else list (aspek .values ())[0 ]].sum ().sum ()>0 :
        df_pos =df_pos_ov
        df_neg =df_neg_ov
...
# ==========================================
# HALAMAN TIME ON TASK ANALYSIS (EFISIENSI)
# ==========================================
...
# ==========================================
# HALAMAN ERROR RATE ANALYSIS (KEAMANAN/AKURASI)
# ==========================================
if menu =="Error Rate":
...
# ==========================================
# HALAMAN UEQ ANALYSIS (USER EXPERIENCE QUESTIONNAIRE)
# ==========================================
...
# ==========================================
# HALAMAN PREFERENSI RESPONDEN (MEAN PREFERENCE)
# ==========================================
