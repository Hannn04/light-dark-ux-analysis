...
# ==========================================
# DATABASE INTERACTION - USER ACCOUNT CRUD
# ==========================================
def load_users ()->dict :
    try :
        res =requests .get (
...
# ==========================================
# REGISTER & LOGIN VALIDATION BUSINESS LOGIC
# ==========================================
...
def logout ():
    ...
    st .session_state .pop ("_cookie_ready",None )
    st .query_params .clear ()
    st .rerun ()


# ==========================================
# VIEW PAGE: USER ACCOUNT SETTINGS
# ==========================================
...
# ==========================================
# VIEW PAGE: AUTHENTICATION (LOGIN & REGISTER)
# ==========================================
